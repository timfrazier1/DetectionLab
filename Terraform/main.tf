...
#  ami = "ami-081754fc6dc359927"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo curl -ku admin:password https://localhost/rest/action_run -d '{\"action\": \"test connectivity\", \"container_id\": 1, \"name\": \"art_test_connectivity\", \"targets\": [{\"assets\": [\"art_main_repo\"], \"parameters\": [], \"app_id\": 193}]}'",
